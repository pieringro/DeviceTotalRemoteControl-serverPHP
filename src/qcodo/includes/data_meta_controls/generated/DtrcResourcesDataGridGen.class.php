<?php
	 ...
	 * listing a collection of DtrcResources objects.  It includes
	 ...
	 * 
	 */
	class DtrcResourcesDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this DtrcResources datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the DtrcResources object, or it can be any QQNode extending from QQN::DtrcResources().
		 * 
		 ...
		 * sorting using two fields from the DtrcResources object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from DtrcResources
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = DtrcResources::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from DtrcResources, given the clauses above
			$this->DataSource = DtrcResources::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a DtrcResources-based QQNode.
		 * It will also verify that it is a proper DtrcResources-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'dtrc_resources') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "dtrc_resources".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::DtrcResources()->Id;
				case 'TextItalian': return QQN::DtrcResources()->TextItalian;
				case 'TextEnglish': return QQN::DtrcResources()->TextEnglish;
				default: throw new QCallerException('Simple Property not found in DtrcResourcesDataGrid content: ' . $mixContent);
