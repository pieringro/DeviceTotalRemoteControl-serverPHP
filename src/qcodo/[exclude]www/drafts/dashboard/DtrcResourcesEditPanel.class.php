<?php
	...
	class DtrcResourcesEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $strId = null, $strControlId = null) {
			...
			$this->strTemplate = 'DtrcResourcesEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the DtrcResourcesMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctDtrcResources = DtrcResourcesMetaControl::Create($this, $strId);
