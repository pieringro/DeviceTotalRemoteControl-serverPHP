<?php
	 ...
	 * list a collection of DtrcPendingEmailUserConfirmation objects.  It includes
	 * functionality to perform pagination and sorting on columns.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QPanel which extends this DtrcPendingEmailUserConfirmationListPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	class DtrcPendingEmailUserConfirmationListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list DtrcPendingEmailUserConfirmations
		public $dtgDtrcPendingEmailUserConfirmations;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = 'DtrcPendingEmailUserConfirmationListPanel.tpl.php';
			...
			$this->dtgDtrcPendingEmailUserConfirmations->ItemsPerPage = 8;
			...
			$this->dtgDtrcPendingEmailUserConfirmations->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
			...
			$this->btnCreateNew->Text = QApplication::Translate('Create a New') . ' ' . QApplication::Translate('DtrcPendingEmailUserConfirmation');
			$this->btnCreateNew->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnCreateNew_Click'));
		}

		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			$strParameterArray = explode(',', $strParameter);
			$objEditPanel = new DtrcPendingEmailUserConfirmationEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
		...
		public function btnCreateNew_Click($strFormId, $strControlId, $strParameter) {
			$objEditPanel = new DtrcPendingEmailUserConfirmationEditPanel($this, $this->strCloseEditPanelMethod, null);
			$strMethodName = $this->strSetEditPanelMethod;
			$this->objForm->$strMethodName($objEditPanel);
		}
	}
